...
class MovementsApiClient {
    ...
    loadAccount() {
        ...
        return new Promise((resolve, reject) => {
            ...
            const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]('GET', this.config.apiEndpoint + '/account?email=' + this.email, { headers: headers });
    ...
    edit(mount, oldMount, type, category, concept, id) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'X-API-TOKEN': 'token-seguridad' });
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]('PUT', this.config.apiEndpoint + '/movement', { 'mount': mount, 'category': category, 'concept': concept, 'id': id }, { headers: headers });
        this.http.request(req).subscribe((data) => {
            if (data.status === 200) {
    ...
    add(movement) {
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'X-API-TOKEN': 'token-seguridad' });
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]('POST', this.config.apiEndpoint + '/movement', movement, { headers: headers });
        this.http.request(req).subscribe((data) => {
            if (data.status === 200) {
    ...
    delete(id) {
        ...
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'X-API-TOKEN': 'token-seguridad' });
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]('DELETE', this.config.apiEndpoint + '/movement?id=' + id, { headers: headers });
        this.http.request(req).subscribe((data) => {
            if (data.status === 200) {
    ...
    updateBalance() {
        ...
        const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"]({ 'X-API-TOKEN': 'token-seguridad' });
        const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpRequest"]('PUT', this.config.apiEndpoint + '/balance', { 'balance': this.balance.getValue(), 'email': this.email }, { headers: headers });
        this.http.request(req).subscribe((data) => {
            if (data.status === 200)
...
class AuthService {
    ...
    createAccount(name, email, password) {
        return new Promise((resolve, reject) => {
            const headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'X-API-TOKEN': 'token-seguridad' });
            const req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpRequest"]('POST', this.config.apiEndpoint + '/account', { 'name': name, 'email': email, 'password': password }, { headers: headers });
            this.http.request(req).subscribe((result) => {
                if (result.status === 200)
                    resolve();
            }, err => {
